...
<head>
	...
	<?php if (isset($footable)) { ?>
		...
		<link rel="stylesheet" media="all" type="text/css" href="<?php echo BASE_URI; ?>includes/js/footable/css/footable.metro.css" />
	...
	<header>
		<div id="header">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span6">
						<img src="<?php echo TIMTHUMB_URL; ?>?src=/img/custom/logo/logo.png&amp;w=250" alt="<?php echo THIS_INSTALL_SET_TITLE; ?>" style="vertical-align: middle;display: inline-block;"/>
						<h1 style="vertical-align: middle;display: inline-block; width: 60%; margin-left: 30px;" ><?php echo THIS_INSTALL_SET_TITLE; ?></h1>
					</div>
					<div class="span6">
						<div id="account">
