...
include('header-unlogged.php');
	...
	?>
		...
		<div class="container">
			<div class="row">
				<div class="span4 offset4 white-box" style="width:50%;margin:auto;float:none">
				<!-- Editado por José García -->
					<div id="header">
						<div id="lonely_logo">
							<img src="<?php echo TIMTHUMB_URL; ?>?src=/img/custom/logo/logo.png&w=150" alt="<?php echo THIS_INSTALL_SET_TITLE; ?>" />
				...
				<!-- Editado por José García -->
					<div class="white-box-interior">
						...
						<form action="index.php" method="post" name="login_admin" role="form">
							<fieldset style="width: 80%;margin: auto;text-align: right;">
								<label for="login_form_user"style="display:inline-block;vertical-align:middle;"><?php _e('Username','cftp_admin'); ?></label>
								<input type="text" name="login_form_user" id="login_form_user" value="<?php if (isset($sysuser_username)) { echo $sysuser_username; } ?>" class="span3" style="display:inline-block;vertical-align:middle;border: 1px solid rgb(200, 200, 200);box-shadow: none;background: white;border-radius: 0;"/>
								<br>
								<label for="login_form_pass"style="display:inline-block;vertical-align:middle;"><?php _e('Password','cftp_admin'); ?></label>
								<input type="password" name="login_form_pass" id="login_form_pass" class="span3" style="display:inline-block;vertical-align:middle;border: 1px solid rgb(200, 200, 200);box-shadow: none;background: white;border-radius: 0;"/>
<?php
/*
