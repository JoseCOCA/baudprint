...
<body data-spy="scroll" data-target="#nav-wrap">
   ...
   <div class="intro-cont col g-8" style="position:fixed;" >
      <div id="engrane-bg" class="w-100 absolute"></div>
      <div id="engrane-1" class="w-100 absolute" data-0="transform[quadratic]:rotate(0deg);" data-2500="transform[quadratic]:rotate(268deg);"></div>
      <div id="engrane-2" class="w-100 absolute" data-0="transform[quadratic]:rotate(0deg);" data-2500="transform[quadratic]:rotate(-360deg);"></div>
      <div id="logote-bg" class="w-100 absolute" data-0="opacity:0;" data-500="opacity:0;" data-1000="opacity:1;" ></div>
   </div>
   ...
   ================================================== -->
   <section id="services">
   	<div id="services-head"><img src="images/services.png" data-bottom-top="transform[quadratic]:translateY(10%);"   data-70-top="transform[quadratic]:translateY(-02%);" style="width: 100%;"/></div>
       <div class="row section-head">
         ...
         <div class="col two-thirds">
            <img src="images/parallax/gradient-4.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(100%);" data-center="transform[swing]:translateX(0%);" />
            <img src="images/parallax/gradient-3.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(100%);" data-center="transform[swing]:translateX(-0%);" />
            <img src="images/parallax/pantalla.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(120%);" data-center="transform[swing]:translateX(0%);" />
            <img src="images/parallax/impresora.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(170%);" data-center="transform[swing]:translateX(0%);" />
            <img src="images/parallax/pantone.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(500%);" data-center="transform[swing]:translateX(0%);" />
            <img src="images/parallax/print-2.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(100%);" data-center="transform[swing]:translateX(0%);" />
            <img src="images/parallax/gradient-2.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(350%);" data-center="transform[swing]:translateX(0%);" />
            <img src="images/parallax/print-1.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(300%);" data-center="transform[swing]:translateX(0%);" />
            <img src="images/parallax/gradient-1.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(350%);" data-center="transform[swing]:translateX(0%);" />
         </div>
       ...
       <div class="row section-head" style="padding-top:50px;">
         ...
         <div class="col two-thirds parallax-2">
            <img src="images/parallax/engrane-3.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(-100%);" data-center="transform[swing]:translateX(-0%);" />
            <img src="images/parallax/engrane-2.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(-100%);" data-center="transform[swing]:translateX(-0%);" />
            <img src="images/parallax/reloj.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(-120%);" data-center="transform[swing]:translateX(-0%);" />
            <img src="images/parallax/taladro.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(-170%);" data-center="transform[swing]:translateX(-0%);" />
            <img src="images/parallax/martillo.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(-500%);" data-center="transform[swing]:translateX(-0%);" />
            <img src="images/parallax/camion.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(-100%);" data-center="transform[swing]:translateX(-0%);" />
            <img src="images/parallax/engrane-1.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(-350%);" data-center="transform[swing]:translateX(-0%);" />
            <img src="images/parallax/flexometro.png" class="parallax-disenio" data-bottom-top="transform[swing]:translateX(-300%);" data-center="transform[swing]:translateX(-0%);" />
         </div>
               ...
               <div class="item-wrap">
                  ...
                  <?php
                     for ($o=1; $o < $proyectCount; $o++) { 
                        ...
                        // echo '<b>img: '.$img.'</b><br>';
                     ?>
                     <a href="<?php echo $pathImgs.$img?>" title="<?=$titulo?>" class="fancybox-thumbs"  rel="<?=$tituloA?>"></a>
            <?php
                     }
                  }
               }
