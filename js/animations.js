inits = function(){
      ...
      jarallax.setDefault('h2, #p1, #p2, #p3', {transform:"rotate(10deg)"});
      jarallax.setDefault('#p1, #p2, #p3', {marginLeft:'0px'});
      jarallax.setDefault('#p1', {position:'absolute'});
      ...
      //      [{progress: "0%", transform:"(30deg)"}, {progress: "10%", transform:"(60deg)"}]);

      
      jarallax.addAnimation('#p1',[{progress: "45%", opacity:"0"}, {progress: "50%", opacity:"1"}]);
      jarallax.addAnimation('#p1',[{progress: "50%", opacity:"1"}, {progress: "60%"}]);
      jarallax.addAnimation('#p1',[{progress: "60%", opacity:"1"}, {progress: "70%", opacity:"0"}]);     
      jarallax.addAnimation('#p1',[{progress: "45%", marginLeft:"0"}, {progress: "70%"}]);
